...
public class StringUtils {
    ...
    public static String[] getStringArray(String delimitedStrings){	
    	delimitedStrings = delimitedStrings.replaceAll("[\\[\\]]", "");
    	return TextUtils.isEmpty(delimitedStrings)?null:delimitedStrings.split(",");
    }
    ...
    public static String getAppendedString(String[] arr){
    	...
    	Log.d("WASTE", "value before:"+value);
    	value = value.replaceAll("[\\[\\]\\' ']", "");
    	Log.d("WASTE", "value after:"+value);
    	return value;
